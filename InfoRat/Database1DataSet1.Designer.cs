...
namespace InfoRat {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string FirstName, string LastName, string Contact) {
...
namespace InfoRat.Database1DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([ID] = @Original_ID) AND ([FirstName] = @Origin" +
                "al_FirstName) AND ([LastName] = @Original_LastName) AND ([Contact] = @Original_C" +
                "ontact))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([FirstName], [LastName], [Contact]) VALUES (@FirstName" +
                ", @LastName, @Contact);\r\nSELECT ID, FirstName, LastName, Contact FROM [Table] WH" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [FirstName] = @FirstName, [LastName] = @LastName, [Contact] = @Contact WHERE (([ID] = @Original_ID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Contact] = @Original_Contact));
SELECT ID, FirstName, LastName, Contact FROM [Table] WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::InfoRat.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FirstName, LastName, Contact FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_ID, string Original_FirstName, string Original_LastName, string Original_Contact) {
        ...
        public virtual int Update(string FirstName, string LastName, string Contact, int Original_ID, string Original_FirstName, string Original_LastName, string Original_Contact, int ID) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Contact, int Original_ID, string Original_FirstName, string Original_LastName, string Original_Contact) {
            return this.Update(FirstName, LastName, Contact, Original_ID, Original_FirstName, Original_LastName, Original_Contact, Original_ID);
        }
    }
